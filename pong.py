...
playerSpeed = 7
objArray = []
gunPic = "data\download.png"
parry_sound = p.mixer.Sound("data\parry.wav")
bg_sound = p.mixer.Sound("data\The Twinning - Final Fantasy XIV (Piano Arrangement).wav")
point_sound = p.mixer.Sound("data\Roblox Death Sound (Oof) - Sound Effect (HD).wav")
state = "RUNNING"
scoreGoal = 1000
...
def displayScore(playerScore, cpuScore, x , y):
    font = p.font.Font("data\Evil Empire.otf", 75)
...
def displayWinner(name,score, x, y):
    font = p.font.Font("data\Evil Empire.otf", 50)
